...
const ProductForm = () => {
  ...
  return (
    <section className={styled.appContainer}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} onKeyDown={handleKeyDown} className={styled.form}>
        <Box sx={{ width: '100%' }}>
            ...
            <section className={styled.tabs}>
              ...
              <div className={styled.row}>
                <div className={styled.formGroup} id={styled.stockAlertField}>
                  <label htmlFor="estoque_alertas">Estoque p/ Alertas</label>
                  <input 
                    id="estoque_alertas" 
                    type="number" 
                    min={0} 
          ...
          <CustomTabPanel className={styled.contextForm} value={value} index={1}>
            <section className={styled.tabs}>
              <div className={styled.row}>
                ...
                <div className={styled.formGroup} id={styled.subCategoryField}>
              ...
              <div className={styled.row}>
                ...
                <div className={styled.formGroup} id={styled.grossWeight}>
                  <label htmlFor="peso_bruto">Peso Líquido*</label>
                  <input 
                    className={errors?.peso && (styled.inputError)} 
                    id="peso_bruto" 
                    type="number" 
